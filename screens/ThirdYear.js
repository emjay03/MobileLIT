        ...
        <View className="flex flex-col mt-[200px] py-2 ">
          ...
          <View className=" px-4 pb-4  ">
            <TouchableHighlight
              ...
              onPress={() =>
                navigation.navigate('ThirdLearningOutcomesModule1')
              }>
              <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg ">
                ...
                <View className=" w-4/5 flex-col px-2">
                  ...
                  <Text
                    ...
                    The module aims to provide an understanding of the key concepts, 
                    principles, and practices involved in developing 
                    and deploying web services and integrating different systems and applications.
                  </Text>
                </View>
              </View>
            </TouchableHighlight>
          ...
          <View className="p-4  ">
            <TouchableHighlight
              underlayColor="#E5E7EB"
              onPress={() => navigation.navigate('SecondLearningOutcomesModule3')}>
              <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg">
                <View className="w-1/5 flex-col justify-center text-center">
                  <Text
                    style={styles.Bold}
          ...
          <View className="p-4  ">
            <TouchableHighlight
              underlayColor="#E5E7EB"
              onPress={() => navigation.navigate('SecondLearningOutcomesModule4')}>
              <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg">
                <View className="w-1/5 flex-col justify-center text-center">
                  <Text
                    style={styles.Bold}
          ...
          <View className="p-4  ">
            <TouchableHighlight
              underlayColor="#E5E7EB"
              onPress={() => navigation.navigate('SecondLearningOutcomesModule5')}>
              <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg">
                <View className="w-1/5 flex-col justify-center text-center">
                  <Text
                    style={styles.Bold}
          ...
          <View className="p-4  ">
            <TouchableHighlight
              underlayColor="#E5E7EB"
              onPress={() => navigation.navigate('SecondLearningOutcomesModule6')}>
              <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg">
                <View className="w-1/5 flex-col justify-center text-center">
                  <Text
                    style={styles.Bold}
          ...
          <View className="p-4  ">
            <TouchableHighlight
              underlayColor="#E5E7EB"
              onPress={() => navigation.navigate('SecondLearningOutcomesModule7')}>
              <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg">
                <View className="w-1/5 flex-col justify-center text-center">
                  <Text
                    style={styles.Bold}
          ...
          <View className="p-4  ">
            <TouchableHighlight
              underlayColor="#E5E7EB"
              onPress={() => navigation.navigate('SecondLearningOutcomesModule8')}>
              <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg">
                <View className="w-1/5 flex-col justify-center text-center">
                  <Text
                    style={styles.Bold}
          ...
          <View className="p-4  ">
            <TouchableHighlight
              underlayColor="#E5E7EB"
              onPress={() => navigation.navigate('SecondLearningOutcomesModule9')}>
              <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg">
                <View className="w-1/5 flex-col justify-center text-center">
                  <Text
                    style={styles.Bold}
