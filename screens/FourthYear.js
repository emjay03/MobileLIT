    ...
    <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg ">
      ...
      <View className=" w-4/5 flex-col px-2">
        ...
        <Text style={styles.Medium} className=" text-[#272727] text-[15px] leading-5">Programming fundamentals are the essential concepts that serve as the building blocks of computer programming..{' '}</Text>
          ...
          {/* Open Module 2 */}
          <View className=" px-4 pb-4  ">
          <TouchableHighlight    underlayColor="#E5E7EB"  onPress={() => navigation.navigate('FourthLearningOutcomesModule2')}>
    <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg ">
      <View className="w-1/5 flex-col justify-center text-center">
        <Text style={styles.Bold} className=" text-center text-[#50D890] ">Module </Text>
      ...
      <View className=" w-4/5 flex-col px-2">
        ...
        <Text style={styles.Medium} className=" text-[#272727] text-[15px] leading-5">Programming fundamentals are the essential concepts that serve as the building blocks of computer programming..{' '}</Text>
          ...
          {/* Open Module 3 */}
          <View className=" px-4 pb-4  ">
          <TouchableHighlight    underlayColor="#E5E7EB"  onPress={() => navigation.navigate('FourthLearningOutcomesModule3')}>
    <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg ">
      <View className="w-1/5 flex-col justify-center text-center">
        <Text style={styles.Bold} className=" text-center text-[#50D890] ">Module </Text>
      ...
      <View className=" w-4/5 flex-col px-2">
        ...
        <Text style={styles.Medium} className=" text-[#272727] text-[15px] leading-5">Programming fundamentals are the essential concepts that serve as the building blocks of computer programming..{' '}</Text>
          ...
          {/* Open Module 4 */}
          <View className="p-4  ">
          <TouchableHighlight    underlayColor="#E5E7EB"  onPress={() => navigation.navigate('FourthLearningOutcomesModule4')}>
            <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg">
              <View className="w-1/5 flex-col justify-center text-center">
        ...
        {/* Open Module 5 */}
        <View className="p-4  ">
          <TouchableHighlight    underlayColor="#E5E7EB"  onPress={() => navigation.navigate('FourthLearningOutcomesModule5')}>
            <View className=" py-3  flex flex-row bg-[#fffdff] rounded-md h-auto shadow-lg">
              <View className="w-1/5 flex-col justify-center text-center">
              <Text style={styles.Bold} className=" text-center text-[#50D890]  ">
