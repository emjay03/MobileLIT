  ...
  const code =
    ...
    public class Program {
        ...
        public static void Main() {
            ...
            if (isPalindrome) {
                Console.WriteLine($"The string \"{inputStr}\" is a palindrome.");
            } else {
                Console.WriteLine($"The string \"{inputStr}\" is not a palindrome.");
            }
        }
    }`
      .split('\n')
...
export default Acceptstringcsharp;
