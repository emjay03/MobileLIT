...
const Caesarpython = () => {
  const code =
    ...
    """
    Encrypts the given plaintext using the Caesar Cipher technique with the given shift.
    """
    ciphertext = ""
...
def decrypt(ciphertext, shift):
    """
    Decrypts the given ciphertext using the Caesar Cipher technique with the given shift.
    """
    plaintext = ""
