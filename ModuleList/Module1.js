    ...
    <ScrollView className="flex-col bg-white">
      <View className="p-4">
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          The evolution of computing refers to the historical development of
          computing technologies and their impact on society, from the early
          days of mechanical calculators to the modern era of cloud computing
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            ...
            From Counting on fingers to pebbles, to hash marks on walls, to hash
            marks on bone, to hash marks in sand.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            The first development of signs corresponding to spoken, instead of
            pictures, to express words started in 3100 B.C. when the Sumerians
            in Mesopotamia (Southern Iraq) invented Cuneiform.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
    ...
    <ScrollView>
      <View className="p-4 bg-white ">
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            The Abacus was considered as the first informative processors, and
            was the man’s first recorded adding machine
          </Text>
        </View>
        <View className="flex items-center pb-4">
          <Image
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          The first information explosion started on this age, especially when
          Johann Gutenberg invented the movable metal-type printing process in
          1450
        </Text>
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            Invented by Blaise Pascal between 1642 and 1645. The 1st digital
            calculator.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />a boxed
            wheel-and-cog device
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            It could add and subtract by the simple rotation of dials on the
            machine’s face
          </Text>
        </View>
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            First machine that could do subtraction, multiplication, and
            division easily.
          </Text>
        </View>
        <View className="flex items-center">
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            Simplifies the process of manufacturing textiles with complex
            patterns such as brocade, damask and matelassé controlled by punched
            cards with punched holes, each row of which corresponds to one row
            of the design.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
  ...
  return (
    <ScrollView>
      <View className="p-4 bg-white ">
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          Charles Babbage is recognized today as the Father of Computers because
          his impressive designs for the Difference Engine and Analytical Engine
        </Text>
        <View className="py-1"></View>
        <Text style={styles.SemiBold} className="text-xl py-2 text-[#272727]">
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          Babbage’s inventions were born of the advances in technology that
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          A mechanical adding machine that took information from punch card to
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          Ada Lovelace is considered to be the “first programmer” who wrote her
          first program for Babbage’s difference engine
        </Text>
        <View className="flex items-center">
          <Image
            className="rounded-lg h-[220px] object-cover bg-cover w-[340px] mt-4"
    ...
    <ScrollView>
      <View className="p-4 bg-white ">
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-[15px]">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            An electrical device designed to assist in summarizing information
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          In early 1940’s electronic vacuum tube was developed by Lee De Forest,
          and this was important during those time because it provides an
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            The ABC was the first electronic digital computer, invented by John
            Vincent Atanasoff in 1937 and was officially released in 1942.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            Devised by Howard H. Aiken, built at IBM and shipped to Harvard in
            February 1944
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            has been described as "the beginning of the era of the modern
            computer"
          </Text>
        </View>
    ...
    <ScrollView>
      <View className="p-4 bg-white ">
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            Designed to calculate artillery firing tables for the US Army's
        ...
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
          UNIVAC or the Universal Automatic Computer designed as a commercial
    ...
    <ScrollView>
      <View className="p-4 bg-white ">
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            approaching 10000 transistors, began to be produced around 1974, for
        ...
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
          A group of related technologies used in an attempt to develop machines
          to emulate human-like qualities
        </Text>
        <View className="flex items-center">
          <Image
            className="rounded-lg h-[220px] object-cover bg-cover w-[340px] mt-4"
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />A
            personal computer; designed to meet the computer needs of an
            individual.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            Provides access to a wide variety of computing applications, such as
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />A
            microcomputer that fits on a desk and runs on power from an
    ...
    <ScrollView>
      <View className="p-4 bg-white ">
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />A
            portable, compact computer that can run on an electrical wall outlet
            or a battery unit.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            Can also be an ordinary personal computer attached to a LAN (local
            area network).
          </Text>
        </View>
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />A
            computer that was the fastest in the world at the time it was
            constructed.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            Used to store, manage, and process large amounts of data that need
    ...
    <ScrollView className="bg-white h-auto">
      <View className="p-4  ">
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />A
            computer that has the purpose of supplying its users with data;
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />A
            computer that fits into a pocket, runs on batteries, and is used
