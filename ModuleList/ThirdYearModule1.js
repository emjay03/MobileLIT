    ...
    return (
      <ScrollView>
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text stlye={styles.SemiBold}>Lower Cost: </Text>Using Web Integration, the effort required becomes much 
            less expensive compared to traditional integration.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text stlye={styles.SemiBold}>Non-intrusive: </Text>
            Web Integration is done non-intrusively, 
            thereby lowering the risk and impact of the entire integration project
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text stlye={styles.SemiBold}>Faster Development: </Text>application design becomes much
             easier and less prone to error
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text stlye={styles.SemiBold}>Faster Overall Integration: </Text>Even complex Web Integration projects can be 
            completed in weeks rather than months.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text stlye={styles.SemiBold}>Lower Skill Requirements: </Text>A traditional integration project requires highly 
        ...
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
        XML databases are databases that are designed to 
        store and manage data in XML format. XML databases 
        allow for the storage of large amounts of information in a structured format, 
        making it easier to manage and query the data.
        </Text>
        <View className="py-1"></View>
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
        XML databases also allow for the serialization of data, 
        which means that the data can be converted into different 
        formats, such as HTML or PDF, for easy distribution and sharing. 
        This makes XML databases a useful tool for managing and 
        sharing large amounts of complex data in a variety of formats.
        </Text>
        <View className="py-1"></View>
        <Text style={styles.SemiBold} className="text-xl py-2  text-[#272727]">
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text stlye={styles.SemiBold}>XML- enabled: </Text>In an XML-enabled database, XML documents are 
            treated as first-class citizens, meaning that they can be stored, queried, and manipulated 
            just like any other data type in the database. This is accomplished by extending the 
            relational database engine with additional functionality to support XML data, such as the ability to store
             XML documents in a relational format.
          </Text>
          <View className="py-2">
          <Image
            className="rounded-lg h-[220px] object-cover bg-cover w-[340px] "
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            ...
            In a Native XML Database, data is stored in its original 
            XML format, which allows for greater flexibility and efficiency 
            when querying and manipulating the data. NXDs use a 
            container-based format, which means that entire XML 
            documents can be stored in a single container, rather than being split across
             multiple tables, as in a relational database.
          </Text>
          <View className="py-2">
          <Image
            className="rounded-lg h-[220px] object-cover bg-cover w-[340px] "
