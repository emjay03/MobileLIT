...
const Module4 = ({navigation}) => {
  ...
  return (
    ...
    <View className="p-4">
      ...
      <Text style={styles.Regular} className="text-[#272727] text-base">HTML is an acronym which stands for Hyper Text Markup Language which is used for creating web pages 
      ...
      <Text style={styles.Regular} className="text-[#272727] text-base">HyperText simply means 
      ...
      <Text style={styles.Regular} className="text-[#272727] text-base"> A markup language is a computer
...
<Entypo
            ...
            /><Text style={styles.SemiBold}>Face: </Text>defines the font to be used.
</Text>
<View className="py-1"></View>
<Text style={styles.Regular} className="text-[#272727] text-base">
<Entypo
            ...
            /><Text style={styles.SemiBold}>Color: </Text>defines the color
</Text>
<View className="py-1"></View>
<Text style={styles.Regular} className="text-[#272727] text-base">
<Entypo
            ...
            /><Text style={styles.SemiBold}>Size: </Text>defines the size
</Text>
...
<Entypo
            ...
            /><Text style={styles.SemiBold}>TIFF: </Text>(Tagged Image File Format)
</Text>
<View className="py-1"></View>
<Text style={styles.Regular} className="text-[#272727] text-base">
<Entypo
    ...
    CHECKBOX CONTROLS 
      ...
      <View className="flex justify-center items-center py-4">
          <TouchableHighlight
            className="my-2 w-1/2 rounded-md bg-[#0C4294] flex justify-center items-center"
            underlayColor="#105aca"
            onPress={() => navigation.navigate('QuizModule4')}>
            <Text
              style={styles.SemiBold}
              className="text-[17px] py-2 text-white">
              Take Quiz
