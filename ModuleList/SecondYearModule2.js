  ...
  return (
    <ScrollView>
      <View className="p-4 bg-white ">
        ...
        SQL (Structured Query Language) that is used to define
         the structure and schema of a database. DDL statements are used to 
        create, modify, and delete database objects such as tables, views, indexes, and procedures.
        </Text>
        <View className="py-1"></View>
        <View className="px-4 ">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            ...
            />
            <Text style={styles.SemiBold}>CREATE: </Text>It is used to create objects in the database.
          </Text>
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            ...
            />
            <Text style={styles.SemiBold}>ALTER: </Text>It is used to alter the structure of the database.
            ports.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            ...
            />
            <Text style={styles.SemiBold}>DROP: </Text>It is used to delete objects from the database.
          </Text>
          <View className="py-1"></View>
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            ...
            />
            <Text style={styles.SemiBold}>TRUNCATE: </Text>It is used to remove all records from a table.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo
            ...
            />
            <Text style={styles.SemiBold}>RENAME: </Text>It is used to rename an object.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo
            ...
            />
            <Text style={styles.SemiBold}>COMMENT: </Text>It is used to comment on the data dictionary.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo
            ...
            <Text style={styles.SemiBold}>SELECT: </Text>It is used to retrieve data from a database.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo
            ...
            />
            <Text style={styles.SemiBold}>INSERT: </Text>It is used to insert data into a table
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo
            ...
            />
            <Text style={styles.SemiBold}>UPDATE: </Text>It is used to update existing data within a table.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo
            ...
            />
            <Text style={styles.SemiBold}>DELETE: </Text>It is used to delete all records from a table.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo
            ...
            />
            <Text style={styles.SemiBold}>GRANT: </Text>It is used to give user access privileges to a database.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo
            ...
            />
            <Text style={styles.SemiBold}>REVOKE: </Text>It is used to take back permissions from the user.
          </Text>
        </View>
        <View className="py-1"></View> 
        <Text style={styles.SemiBold} className="text-xl py-2 text-[#272727]">
        ...
        conceptual model used in database design to represent the 
        entities and their relationships in a database system. 
        The ER model is used to create a visual representation of the data 
        requirements for a system, and it serves as a blueprint for the actual database design.
        </Text>
        <View className="py-1"></View>
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
        In the ER model, an entity is a real-world 
        object or concept that has attributes and 
        relationships with other entities. For example,
         in a university database, entities could include students, courses, professors, and departments. 
        Each entity is represented as a rectangular box with the entity name written inside.
        </Text>
        ...
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
        An Entity Relationship (ER) Diagram is a type of diagram 
        used in database design to visually represent the entities, 
        attributes, and relationships between them in a database system. 
        It is a graphical representation of the Entity-Relationship (ER) model.
        </Text>
        <View className="py-1"></View>
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
        In an ER diagram, each entity is represented as a
         rectangular box, and the attributes of the entity 
         are represented as ovals attached to the entity box. 
         The relationships
         between the entities are represented as lines connecting the entities.
        </Text>
...
Entity
        ...
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
        In database terminology, an entity is 
        an object or concept that has a unique identity
         and can be distinguished from other objects. 
         It can be a real-world object such as a customer, an employee, or a product, or 
        it can be an abstract concept such as an order, a reservation, or an invoice.
        </Text>
        <View className="py-1"></View>
        <Text style={styles.SemiBold} className="text-xl py-2 text-[#272727]">      
...
Strong Entity
        ...
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
        A strong entity has its own attributes that define its 
        unique characteristics, and it does not depend on any other 
        entity to be identified. For example, in a university database, 
        a student entity is a strong entity because it has its own unique
         identifier (such as a student ID number)
         and its own set of attributes (such as name, address, and date of birth).
        </Text>
...
Weak Entity
        ...
        <Text style={styles.Regular} className="text-[#272727] text-base  ">
        A weak entity cannot be identified by its own 
        attributes alone and requires a relationship with a strong 
        entity to provide its unique identity. The relationship between 
        the weak entity and the strong entity is called the identifying relationship, and it is 
        typically represented as a diamond shape in an Entity-Relationship (ER) Diagram.
        </Text>
    ...
    return (
      <ScrollView>
        <View className="p-4 bg-white ">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">Attributes can have 
          different data types, such as integers, strings, dates, or Booleans, depending on 
          the type of information they represent. They can also have constraints, such as a
           maximum length, a range of values, or a required value. These constraints help ensure the quality and
           integrity of the data stored in the database.</Text>
           <View className="py-1"></View>
           <Text style={styles.SemiBold} className="text-xl py-2 text-[#272727]">      
          Types of Attributes
          </Text>
...
<Image
    ...
    Simple Attribute
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">are atomic values, 
          which cannot be divided further.
For example, a student's mobile number is an atomic value of 11 digits.
</Text>
<View className="py-1"></View>
    <Text style={styles.SemiBold} className="text-xl py-2 text-[#272727]">      
    Composite Attribute
          </Text>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">are made 
...
<View className="py-1"></View>
    ...
    Derived Attribute
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">are the attributes that do not exist in the physical database, but their values are derived from other attributes present in the database.
    ...
    return (
      <ScrollView>
        <View className="p-4 bg-white ">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">contain single value.
For example, a Social_Security_Number.
</Text>
           <View className="py-1"></View>  
    ...
    Multi-valued Attribute
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">Multi-value 
...
<View className="py-1"></View>
    ...
    Relationship
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">It describes the association among entities.
</Text>
<View className="py-1"></View>
<Image
           className="rounded-lg h-[220px] object-cover bg-cover w-[340px] "
...
Cardinality Constraints
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">It specifies the maximum number
           of entity instance which associates 
