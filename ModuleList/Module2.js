      ...
      <View className="p-4">
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            ...
            network of computers. The word “Internet” literally means, Network
            of networks.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            Tim Berners-Lee invented the World Wide Web in 1989. He became a
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          {' '}
          A markup language is a computer language that is used to apply layout
          and formatting conventions to a text document. Markup language makes
          text more interactive and dynamic. It can turn text into images,
          tables, links, etc.
        </Text>
        <View className="py-1"></View>
        <Text style={styles.SemiBold} className="text-xl py-2 text-[#272727]">
  ...
  return (
    <ScrollView>
      <View className="p-4 bg-white ">
        <Text
          style={styles.KarlaSemiBold}
          className="text-[#272727] py-2 text-xl">
          Header Tag
        </Text>
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
        ...
        <Text
          style={styles.SemiBold}
          className="text-2xl py-3 text-center text-[#50D890]">
  ...
  return (
    <ScrollView>
      <View className="p-4 bg-white ">
        <Text
          style={styles.SemiBold}
          className="text-xl py-2 text-center text-[#50D890]">
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />{' '}
            <Text style={styles.SemiBold}>JPEG:</Text>(Joint Photographic
            Experts Group)
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />{' '}
            <Text style={styles.SemiBold}>TIFT: </Text>(Tagged Image File
            Format)
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />{' '}
            <Text style={styles.SemiBold}>PNG: </Text>(Portable Network
            Graphics)
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>GIF: </Text>(Graphic Interchange
            Format)
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
    ...
    <ScrollView>
      <View className="p-4 bg-white ">
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>Src: </Text>Specifies the path to the
            image
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>Align: </Text>-align attribute is used
            to set the alignment of an image. It is an inline element. It is
            used to specify the alignment of the image according to surrounding
            elements.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>Alt: </Text>Specifies an alternate
            text for an image.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>Border: </Text> border attribute is
            used to specify the border width around the image. The default value
            of {'<img>'} border attribute is 0
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>Height: </Text>The height attribute
            specifies the height of an image, in pixels
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>Hspace: </Text>hspace attribute is
            used to specify the number of whitespaces on the left and the right
            side of the image
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />{' '}
            <Text style={styles.SemiBold}>Vspace: </Text>vspace Attribute is
            used to specify the number of whitespaces on bottom and top side of
            an image.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>Width: </Text>The width attribute
            specifies the width of an image, in pixels. Tip: Always specify both
            the height and width attributes for images. If height and width are
            set, the space required for the image is reserved when the page is
            loaded.
          </Text>
        </View>
        <Text style={styles.SemiBold} className="text-[#272727] py-2 text-xl">
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>{'<ul>'}: </Text>An unordered list.
            This will list items using plain bullets.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />{' '}
            <Text style={styles.SemiBold}>{'<ol>'}: </Text>An ordered list. This
            will use different schemes of numbers to list your items.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            <Text style={styles.SemiBold}>{'<dl>'}: </Text> A definition list.
            This arranges your items in the same way as they are arranged in a
            dictionary.
          </Text>
        </View>
        <View className="py-2"></View>
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            ...
            successive ordered list element
          </Text>
        </View>
        <View className="py-1"></View>
        <Text style={styles.SemiBold} className="text-[#272727] py-2 text-xl">
    ...
    <ScrollView>
      <View className="p-4 bg-white ">
        ...
        <View className="px-4">
          ...
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            <Entypo name="arrow-bold-right" size={15} color="#50D890" />
            {'<caption>'} will serve as a title or explanation for the table and
        ...
        <View className="px-4">
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            1. Single-line text input controls – This control is used for items
            that require only one line of user input.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            2. Password input controls – This is also a single-line text but it
            masks the character as soon as a user enters it.
          </Text>
          <View className="py-1"></View>
          <Text style={styles.Regular} className="text-[#272727] text-base  ">
            3. Multi-line text input controls - This is used when the user is
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          Used when out of many options, just one option is required to be
          selected.
        </Text>
        <View className="py-2"></View>
        <Text style={styles.SemiBold} className="text-xl py-2 text-[#272727]">
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          - Also called drop down box which provides option to list down various
          options in the form of drop down list, from where a user can select
          one or more options.
        </Text>
        <View className="py-2"></View>
        <Text style={styles.SemiBold} className="text-xl py-2 text-[#272727]">
        ...
        <Text style={styles.Regular} className="text-[#272727] text-[15px]">
          A {'<button>'} of type button which, when clicked, starts a JavaScript
          process.
        </Text>
        ...
        <View className="flex justify-center items-center py-4">
          <TouchableHighlight
            className="my-2 w-1/2 rounded-md bg-[#0C4294] flex justify-center items-center"
            underlayColor="#105aca"
            onPress={() => navigation.navigate('Quizmodule2')}>
            <Text
              style={styles.SemiBold}
              className="text-[17px] py-2 text-white">
              Take Quiz
