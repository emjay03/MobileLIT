    ...
    <ScrollView className="bg-white ">
      <View className="px-5 ">
        <Text className="text-[#272727] text-base py-3" style={styles.Normal}>
          <Text style={styles.KarlaSemiBold}>Java </Text>
      ...
      <View className="flex flex-row  w-[100%] bg-white border-2 rounded-xl border-[#f5f5f5]">
          ...
          <TouchableHighlight
            ...
            onPress={() => navigation.navigate('hellojava')}
        ...
        <View className="flex flex-row  w-[100%] bg-white border-2 rounded-xl border-[#f5f5f5]">
          ...
          <TouchableHighlight
            className=" w-[80%]   flex justify-center items-center"
            onPress={() => navigation.navigate('areaofrectanglejava')} 
            underlayColor={{color: '#e2e2e2', borderRadius: 10}}>
            <Text
              style={styles.Regular}
              className=" text-center text-[#272727] text-[16px]  py-1 px-2">
        ...
        <View className="flex flex-row  w-[100%] bg-white border-2 rounded-xl border-[#f5f5f5]">
          ...
          <TouchableHighlight
            className=" w-[80%]   flex justify-center items-center"
            onPress={() => navigation.navigate('capitalizejava')}
            underlayColor={{color: '#e2e2e2', borderRadius: 10}}>
            <Text
              style={styles.Regular}
              className=" text-center text-[#272727] text-[16px]  py-1 px-2">
        ...
        <View className="flex flex-row  w-[100%] bg-white border-2 rounded-xl border-[#f5f5f5]">
          ...
          <TouchableHighlight
            className=" w-[80%]   flex justify-center items-center"
            onPress={() => navigation.navigate('guessjava')}
            underlayColor={{color: '#e2e2e2', borderRadius: 10}}>
            <Text
              style={styles.Regular}
              className=" text-center text-[#272727] text-[16px]  py-1 px-2">
        ...
        <View className="flex flex-row  w-[100%] bg-white border-2 rounded-xl border-[#f5f5f5]">
          ...
          <TouchableHighlight
            className=" w-[80%]   flex justify-center items-center"
            onPress={() => navigation.navigate('findlargestnumjava')}
            underlayColor={{color: '#e2e2e2', borderRadius: 10}}>
            <Text
              style={styles.Regular}
              className=" text-center text-[#272727] text-[16px] py-1 px-2">
        ...
        <View className="flex flex-row  w-[100%] bg-white border-2 rounded-xl border-[#f5f5f5]">
          ...
          <TouchableHighlight
            className=" w-[80%]   flex justify-center items-center"
            onPress={() => navigation.navigate('capitalizefirstletterjava')}
            underlayColor={{color: '#e2e2e2', borderRadius: 10}}>
            <Text
              style={styles.Regular}
              className=" text-center text-[#272727] text-[16px]  py-1 px-2">
        ...
        <View className="flex flex-row  w-[100%] bg-white border-2 rounded-xl border-[#f5f5f5]">
          ...
          <TouchableHighlight
            className=" w-[80%]   flex justify-center items-center"
            onPress={() => navigation.navigate('countnumjava')}
            underlayColor={{color: '#e2e2e2', borderRadius: 10}}>
            <Text
              style={styles.Regular}
              className=" text-center text-[#272727] text-[16px]  py-1 px-2">
