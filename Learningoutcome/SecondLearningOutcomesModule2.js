      ...
      <ScrollView className=" flex-col bg-white px-4 ">
        <View className="p-3">
          <View className="flex flex-col justify-center items-center">
            ...
            Building a Strong Foundation: Database System Concepts, Architecture, and Entity Relationship Diagrams
            </Text>
            ...
            <TouchableHighlight className="bg-[#4F98CA] py-3 px-20 rounded-md"  underlayColor="#E5E7EB"  onPress={() => navigation.navigate('SecondYearModule2')}> 
