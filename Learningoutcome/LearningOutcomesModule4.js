       ...
       Introducing To Operating System
        ...
        <View className="py-5 ">
          ...
          <View className="flex flex-row w-auto items-center ">
            ...
            <Text style={styles.Description}  className="w-auto  pr-8 text-[16px]">
        ...
        <TouchableHighlight className="bg-[#6C63FF] py-3 px-20 rounded-md"  underlayColor="#E5E7EB"  onPress={() => navigation.navigate('Module4')}> 
