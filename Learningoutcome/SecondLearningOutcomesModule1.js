...
import React, { useState, useEffect } from 'react';
  ...
  const SecondLearningOutcomesModule1 = ({navigation}) => {
      ...
      <ScrollView className=" flex-col bg-white px-4 ">
        <View className="p-3">
          <View className="flex flex-col justify-center items-center">
            ...
            Fundamentals of Data Structures and Algorithms: Properties, Notation, and Importance of Classification
            </Text>
          ...
          <View className="py-2"></View>
                  <TouchableHighlight className=" bg-[#0C4294]   py-3 px-20 rounded-md"  underlayColor="#105aca" onPress={() => setModalVisible(false)} >
                    ...
                    <View className="py-2"></View>
                    <TouchableHighlight className=" bg-[#f2f2f2]  py-3 px-20 rounded-md"  underlayColor="#d9d9d9"  onPress={() => navigation.navigate('Second Year Module')}> 
  ...
  export default SecondLearningOutcomesModule1;
